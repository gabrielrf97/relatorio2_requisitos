...
\subsection{Histórias de Usuário da Feature 02: Sincronizar vendas com o armazenamento}
\begin{itemize}

\item US05 - Eu, como usuário, desejo que, ao realizar uma venda, o estoque seja atualizado.
    \begin{itemize}
    \item Prioridade:
    \item Dificuldade:
    \item Critério(s) de aceitação:
